...
<div class="container-two" id="container-content" style="position: relative" }>
    <div class="row">
        ...
        <div class="col-xs-10 col-md-10 right-content">
            ...
            <!--<nav> <?php echo ($boby); ?>></nav>-->
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo ($vo['save_path']); ?>" download="<?php echo ($vo['filename']); ?>"style="display: block;font-size: large"><?php echo ($vo["filename"]); ?></a></br><?php endforeach; endif; else: echo "" ;endif; ?>
