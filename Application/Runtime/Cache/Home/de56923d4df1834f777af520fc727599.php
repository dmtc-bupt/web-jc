        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        <a href="/Home/Information/process" class="dropdown-toggle" data-toggle="dropdown" role="button" data-hover="dropdown" aria-haspopup="true" aria-expanded="false">标准化工作 <span class="caret"></span></a>
                        <ul class="dropdown-menu">
...
<div class="picContainer">
    <img src="/Public/picture/notice.jpg" alt="质检范围">
...
<div class="container-two" id="container-content" style="position: relative" }>
    ...
    <div class="col-xs-10 col-md-10 right-content">
        ...
        <a name="notice">质检范围</a></br>
        </br>
        <?php if(is_array($scope)): $i = 0; $__LIST__ = $scope;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo U('/home/Information/scopeDetail');?>?id=<?php echo ($vo['id']); ?>" style="display: block;font-size: large" ><?php echo ($vo["title"]); ?></a>
